...
- y축: GO term 이름
- 그래프 해석:
  1. 세포 분열/증식 관련(organelle fission, nuclear division, meiotic cell cycle process)<br>: LUAD 종양 세포가 빠르게 증식하고 있으며, 세포주기와 염색체 분리/핵산 구조 조립 과정이 활발히 up-regulated 되어 있음. 암세포의 비정상적인 세포분열을 나타냄
